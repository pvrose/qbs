...
std::string APP_NAME = "QBS";
std::string APP_VERSION = "2.0.3";
std::string APP_VENDOR = "GM3ZZA";
std::string APP_TIMESTAMP = "2026-04-18T12:51:25Z";
std::string APP_SOURCE_DIR = "C:/Users/pvros/source/repos/qbs";
